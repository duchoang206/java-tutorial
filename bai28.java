...
Lý thuyết
Trong các chương trước bạn đã biết cách sử dụng các phương thức có sẵn như phương thức length(), toLowerCase(), indexOf(), ... qua bài này 
bạn sẽ hiểu được cách tạo và sử dụng phương thức trong Java.
...
2
3
Việc tách chương trình ra thành các phương thức nhỏ thay vì viết tất cả các đoạn code trong phương thức main()
 sẽ giúp bạn tái sử dụng lại được code, làm cho chương trình trở nên đơn giản, dễ hiểu hơn */
