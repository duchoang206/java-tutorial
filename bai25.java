...
Lý thuyết
Như bạn đã được học về kiểu dữ liệu ký tự (bạn có thể xem lại tại bài này)
 kiểu ký tự bản chất cũng là một kiểu số nguyên, do đó bạn có thể duyệt và hiển thị các ký tự từ '0' -> '9', từ 'a' -> 'z' bằng vòng lặp giống như sau:
